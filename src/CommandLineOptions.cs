namespace WinVerCollector
{
    ...
    {
        [CommandLine.Option('o', "output", Required = false, HelpText = "Output collected windows version info.")]
        public bool IsOutputRequest { get => _isOutputRequest; set => _isOutputRequest = value; }
        private bool _isOutputRequest = false;

        [CommandLine.Option('s', "show", Required = false, HelpText = "Display collected windows version info.")]
        ...
        [CommandLine.Option('v', "verbose", Required = false, HelpText = "Display windows version info.")]
